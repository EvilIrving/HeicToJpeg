...
export const metadata: Metadata = {
  title: {
    template: '%s | Heic Convert',
    default: 'Heic Convert',
  },
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} antialiased`}>
        ...
        <footer className="footer footer-center mt-5 p-10 text-accent-content">
          <aside>
