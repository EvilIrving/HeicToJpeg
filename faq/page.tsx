...
export default function FAQ() {
  ...
  return (
    <div className="max-w-3xl px-4 py-4 lg:py-10 mx-auto">
      <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 className="text-2xl font-bold md:text-3xl md:leading-tight text-gray-800 dark:text-neutral-200">What I have</h2>
      </div>
